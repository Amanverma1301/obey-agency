...
function magnethover(){
    ...
    //To make nav bar magnetic
    Shery.makeMagnet("#nav-part2 h4")

    //This is for video play pause and mouse follower in video container
    ...
    videocontainer.addEventListener("mouseenter",function(){
        ...
        videocontainer.addEventListener("mousemove",function(p){
